...
export const FOCUS_ITEMS: FocusItem[] = [
  ...
  },
  {
    id: "focus-7",
    kind: "deadline",
    title: "Privilege log entries for Harbor Brook production",
    matterRef: "2026-0131",
    clientName: "Harbor Brook Partners",
    dueDate: dayOffset(0),
    dueTime: "5:00 PM",
  ...
  },
  {
    id: "focus-9",
    kind: "task",
    title: "Log yesterday's research block before cutoff",
    matterRef: "MT-05001",
    clientName: "Northvale Robotics LLC",
    dueDate: dayOffset(0),
    priority: "Medium",
    status: "To Do",
    href: "/time/new",
  },
  {
    id: "focus-10",
    kind: "document",
    title: "Mark financing consent sections for client upload",
    matterRef: "MT-05001",
    clientName: "Northvale Robotics LLC",
    dueDate: dayOffset(0),
    priority: "Low",
  ...
  },
  {
    id: "focus-11",
    kind: "court",
    title: "Confirm court reporter for Alvarez deposition",
    matterRef: "2026-0108",
    clientName: "Delta Freight Systems",
    dueDate: dayOffset(0),
    priority: "Critical",
  ...
  },
  {
    id: "focus-12",
    kind: "client",
    title: "Return Nora Vale call on board packet timing",
    matterRef: "MT-05001",
    clientName: "Northvale Robotics LLC",
    dueDate: dayOffset(0),
    priority: "High",
...
/** Partner-flavored focus pads when inbox is thin. */
export const PARTNER_FOCUS_ITEMS: FocusItem[] = [
  {
    id: "pf-1",
    kind: "deadline",
    title: "Approve Northvale filing before 4:00 PM",
    matterRef: "MT-05001",
    clientName: "Northvale Robotics LLC",
    dueDate: dayOffset(0),
    dueTime: "4:00 PM",
  ...
  },
  {
    id: "pf-2",
    kind: "document",
    title: "Review August write-off packet",
    matterRef: "Billing",
    clientName: "Firm",
    dueDate: dayOffset(0),
    priority: "High",
  ...
  },
  {
    id: "pf-3",
    kind: "meeting",
    title: "Firm leadership huddle prep notes",
    matterRef: "—",
    clientName: "Firm",
    dueDate: dayOffset(0),
    dueTime: "8:00 AM",
  ...
  },
  {
    id: "pf-4",
    kind: "client",
    title: "Case evaluation CE-2026-4304 partner decision",
  ...
  },
  {
    id: "pf-5",
    kind: "deadline",
    title: "Past-due AR escalation — INV-010016",
    matterRef: "AR",
    clientName: "Northvale Robotics LLC",
    dueDate: dayOffset(0),
    priority: "High",
  ...
  },
  {
    id: "pf-6",
    kind: "task",
    title: "Sign conflict waiver for new corporate intake",
    matterRef: "CE-2026-9772",
    clientName: "Demo Request",
    dueDate: dayOffset(0),
    priority: "Medium",
    status: "To Do",
    href: "/inbox",
...
/** Paralegal-flavored focus pads. */
export const PARALEGAL_FOCUS_ITEMS: FocusItem[] = [
  {
    id: "plf-1",
    kind: "document",
  ...
  },
  {
    id: "plf-2",
    kind: "task",
    title: "Chase medical records order confirmation",
    matterRef: "2026-0108",
    clientName: "Delta Freight Systems",
    dueDate: dayOffset(0),
    priority: "High",
  ...
  },
  {
    id: "plf-3",
    kind: "deadline",
    title: "Court reporter exhibit labels",
    matterRef: "2026-0108",
    clientName: "Delta Freight Systems",
    dueDate: dayOffset(0),
    priority: "High",
  ...
  },
  {
    id: "plf-4",
    kind: "client",
    title: "Intake follow-up — CE-2026-9772",
    matterRef: "CE-2026-9772",
    clientName: "Demo Request",
    dueDate: dayOffset(0),
    priority: "Medium",
  ...
  },
  {
    id: "plf-5",
    kind: "task",
    title: "Assemble board packet tabs for Northvale",
    matterRef: "MT-05001",
    clientName: "Northvale Robotics LLC",
    dueDate: dayOffset(0),
    priority: "High",
  ...
  },
  {
    id: "plf-6",
    kind: "document",
    title: "Bates-stamp Harbor Brook production set",
    matterRef: "2026-0131",
    clientName: "Harbor Brook Partners",
    dueDate: dayOffset(0),
    priority: "Medium",
  ...
  },
  {
    id: "plf-7",
    kind: "deadline",
    title: "File stamped notice of appearance draft",
    matterRef: "MT-05003",
    clientName: "Riverbend Community Arts",
    dueDate: dayOffset(0),
    priority: "Low",
    status: "Review",
    href: "/tasks",
...
/** Billing-flavored focus pads. */
export const BILLING_FOCUS_ITEMS: FocusItem[] = [
  {
    id: "bf-1",
    kind: "deadline",
    title: "Daily billing cutoff at 5:30 PM",
    matterRef: "Firm",
    clientName: "Firm",
    dueDate: dayOffset(0),
    dueTime: "5:30 PM",
  ...
  },
  {
    id: "bf-3",
    kind: "task",
    title: "Chase 12 draft time entries blocking invoices",
    matterRef: "Firm",
    clientName: "Firm",
    dueDate: dayOffset(0),
    priority: "High",
  ...
  },
  {
    id: "bf-4",
    kind: "deadline",
    title: "Retainer threshold alert — Cedar Ridge",
    matterRef: "2026-0127",
    clientName: "Cedar Ridge Development",
    dueDate: dayOffset(0),
    priority: "Medium",
  ...
  },
  {
    id: "bf-5",
    kind: "task",
    title: "Code vendor receipts for expense review",
    matterRef: "Firm",
    clientName: "Firm",
    dueDate: dayOffset(0),
    priority: "Medium",
  ...
  },
  {
    id: "bf-6",
    kind: "document",
    title: "Prepare Harbor Brook draft invoice",
    matterRef: "2026-0131",
    clientName: "Harbor Brook Partners",
    dueDate: dayOffset(0),
    priority: "High",
...
export const DEADLINES: WorkspaceDeadline[] = [
  ...
  {
    id: "dl-7",
    title: "Privilege log for document production",
    matterRef: "2026-0131",
    matterName: "Harbor Brook Partners — Vendor Litigation",
    deadlineType: "Discovery",
    dueDate: dayOffset(2),
  ...
  {
    id: "dl-10",
    title: "Zoning board packet filing",
    matterRef: "2026-0127",
    matterName: "Cedar Ridge Development — Land Use",
    deadlineType: "Court Filing",
    dueDate: dayOffset(8),
  ...
  {
    id: "dl-11",
    title: "Engagement letter countersignature",
    matterRef: "MT-05006",
    matterName: "Vendor MSA Template Suite",
    deadlineType: "Client Deliverable",
    dueDate: dayOffset(1),
    priority: "Medium",
  },
...
export const TASKS: WorkspaceTask[] = [
  ...
  {
    id: "tk-11",
    name: "Draft meet-and-confer letter on discovery gaps",
    matterRef: "2026-0108",
    matterName: "Delta Freight Systems — Contract Dispute",
    assignee: "Jordan Harper",
    dueDate: dayOffset(0),
  ...
  {
    id: "tk-12",
    name: "Bates-stamp Harbor Brook production set A",
    matterRef: "2026-0131",
    matterName: "Harbor Brook Partners — Vendor Litigation",
    assignee: "Priya Rose",
    dueDate: dayOffset(0),
  ...
  {
    id: "tk-13",
    name: "Update privilege log spreadsheet",
    matterRef: "2026-0131",
    matterName: "Harbor Brook Partners — Vendor Litigation",
    assignee: "Priya Rose",
    dueDate: dayOffset(1),
  ...
  {
    id: "tk-14",
    name: "Client call notes — settlement authority",
    matterRef: "2026-0108",
    matterName: "Delta Freight Systems — Contract Dispute",
    assignee: "Jordan Harper",
    dueDate: dayOffset(0),
  ...
  {
    id: "tk-15",
    name: "Prepare zoning exhibit list for board hearing",
    matterRef: "2026-0127",
    matterName: "Cedar Ridge Development — Land Use",
    assignee: "Priya Rose",
    dueDate: dayOffset(2),
  ...
  {
    id: "tk-16",
    name: "Partner memo — write-off justification",
    matterRef: "Billing",
    matterName: "August close",
    assignee: "Sam Okonkwo",
    dueDate: dayOffset(0),
    priority: "High",
    lane: "Review",
    practiceArea: "Billing",
  },
  {
    id: "tk-17",
    name: "Chase missing expense receipts (2 vendors)",
    matterRef: "Firm",
    matterName: "Operating expenses",
    assignee: "Sam Okonkwo",
    dueDate: dayOffset(0),
    priority: "Medium",
    lane: "Waiting",
  ...
  {
    id: "tk-18",
    name: "Confirm expert CV and fee schedule",
    matterRef: "2026-0096",
    matterName: "Whitfield Manufacturing — Products Liability",
    assignee: "Jordan Harper",
    dueDate: dayOffset(3),
  ...
  {
    id: "tk-19",
    name: "File stamped corporate annual report proof",
    matterRef: "2026-0122",
    matterName: "Sunbelt Grocers — Corporate Maintenance",
    assignee: "Priya Rose",
    dueDate: dayOffset(-1),
  ...
  {
    id: "tk-20",
    name: "Organize deposition transcript errata",
    matterRef: "2026-0108",
    matterName: "Delta Freight Systems — Contract Dispute",
    assignee: "Priya Rose",
    dueDate: dayOffset(4),
  ...
  {
    id: "tk-21",
    name: "Escalate past-due INV-010016 collection call",
    matterRef: "MT-05001",
    matterName: "Series A Corporate Counsel",
    assignee: "Sam Okonkwo",
    dueDate: dayOffset(0),
    priority: "Critical",
    lane: "In Progress",
  ...
  {
    id: "tk-22",
    name: "Prep Northvale board financing Q&A sheet",
    matterRef: "MT-05001",
    matterName: "Series A Corporate Counsel",
    assignee: "Jordan Harper",
    dueDate: dayOffset(1),
...
export const ACTIVITY: ActivityEvent[] = [
  ...
  },
  {
    ...
    kind: "time_logged",
    actor: "Jordan Harper",
    description: "logged 3.2 hours on motion practice",
    matterRef: "2026-0114",
    minutesAgo: 45,
  },
  {
    ...
    kind: "document_uploaded",
    actor: "Priya Rose",
    description: "uploaded medical record set 4 of 6",
    matterRef: "2026-0108",
    minutesAgo: 70,
  },
  {
    ...
    kind: "task_completed",
    actor: "Priya Rose",
    description: "completed court reporter label order",
    matterRef: "2026-0108",
    minutesAgo: 110,
  },
  {
    ...
    kind: "message_received",
    actor: "Nora Vale",
    description: "asked about board packet financing tabs",
    matterRef: "MT-05001",
    minutesAgo: 160,
  },
  {
    id: "ac-13",
    kind: "status_changed",
    actor: "Margaret Sinclair",
    description: "approved invoice INV-010009",
    matterRef: "MT-05003",
    minutesAgo: 220,
  },
  {
    ...
    kind: "deadline_created",
    actor: "Jordan Harper",
    description: "added privilege log deadline",
    matterRef: "2026-0131",
    minutesAgo: 310,
  },
  {
    ...
    kind: "document_edited",
    actor: "Jordan Harper",
    description: "revised settlement demand outline",
    matterRef: "2026-0108",
    minutesAgo: 480,
  },
  {
    ...
    kind: "time_logged",
    actor: "Priya Rose",
    description: "logged 2.0 hours assembling exhibit binder",
    matterRef: "2026-0114",
    minutesAgo: 600,
  },
];
